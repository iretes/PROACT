...
if __name__ == '__main__':      
    ...
    # Save inversion configuration
    inversion_config = {
        'num_samples': args.num_samples,
        'task_lst': args.task_lst,
        'n_iters': args.n_iters,
        'batch_reg': args.batch_reg
    }
    with open(os.path.join(args.save_dir, 'inversion_config.yaml'), 'w') as f:
        yaml.dump(inversion_config, f, default_flow_style=False)
